                ...
                <div id="defaultModal" tabIndex="-1" aria-hidden="true" className="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    ...
                    <div className="w-full max-w-2xl max-h-full">
                        ...
                        <div className='relative border-b-2'>
                            <input type='text' className='w-11/12 border-2 border-white/0 bg-white/0 placeholder:text-white text-white neueFont' placeholder='Rechercher'>
                            </input>
                            <FontAwesomeIcon icon={faMagnifyingGlass} className='text-white' />
                        </div>
                        <button type="button" data-modal-hide="defaultModal" className="absolute top-20 right-10 h-8">
                            <FontAwesomeIcon icon={faCircleXmark} className="h-8 hover:text-white" />
                        </button>
                    </div>
                </div>
